        ...
        <div className="manage-section">
            ...
            <form onSubmit={handleSubmit} className="admin-form">
                ...
                <div className="form-group">
                    <label style={{ display: 'block', marginBottom: '8px', color: '#666', fontSize: '0.9rem' }}>Image de la catégorie</label>
                    ...
                    <tbody>
                        {categories.map(cat => (
                            <tr key={cat._id}>
                                ...
                                <td>{cat.name_fr}</td>
                                <td>{cat.name_ar}</td>
                                <td><button onClick={() => handleDelete(cat._id)} className="delete-btn">Supprimer</button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
